...
\addcontentsline{toc}{chapter}{Parte I: Introducción}
...
\input{parts/chapters/ruby}

\chapter{Rails}\label{cap.rails}
\input{parts/chapters/rails}
\input{parts/chapters/rails2}

\addcontentsline{toc}{chapter}{Parte II: Desarrollo de la aplicación}

\chapter{Análisis del sistema}\label{cap.analisis}
